...
function CourseCardAvailable({ title, tags, cover, author, description, id }: Props) {
  ...
  return (
    <div ref={hoverRef} className="transition-all hover:drop-shadow-md bg-white shadow-md rounded-lg p-4 text-[#121212]">
      ...
      {isHover && isAdmPage ? (
        <div className="absolute top-1/2 -rigth-1/5 z-9 shadow-black shadow-2xl drop-shadow-2xl bg-transparent">
          <button className="transition-all rounded-md mb-2 text-sm lg:text-lg flex items-center bg-yellow-700 text-black font-medium px-4 py-2 hover:bg-yellow-600">
            Editar informações
          ...
          <button className="transition-all rounded-md mb-2 text-sm lg:text-lg flex items-center bg-green-700 text-white font-medium px-4 py-2 hover:bg-green-600">
